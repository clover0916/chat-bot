...
if __name__ == '__main__':
    ...
    CK = 'uytRsMoecGcwUWsU2qyUobTst'                             # Consumer Key
    CS = 'jFvFhuF1PRiGjY3GqDy9GLjPuMAuUDBs2GP4aR1fF6AT0mRK7y'    # Consumer Secret
    AT = '1254230904152535041-VibZkUBmTTzhPqjg1gZNByaxDVikL8'    # Access Token
    AS = 'rWZwRTRwRXRPE8eXWX8eDIlDYMRM1FzSnbblQtOOVhOBW'         # Accesss Token Secert
